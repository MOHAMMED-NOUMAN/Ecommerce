  ...
  return (
    <div className='min-h-[550px]  flex justify-center items-center py-12'>
      <div className="container">
        <div style={{backgroundColor: data.bgColor}} className="grid grid-cols-1 md:grid-cols-3 gap-y-6 items-center text-white rounded-3xl">
            {/*first col*/} 
            ...
            <div className=' flex flex-col justify-center gap-4 p-5 sm:p-8'>
                <p data-aos="zoom-out" className='text-3xl font-bold'>{data.title2}</p>
                <p data-aos="fade-up" className='text-6xl font-bold'>{data.title3}</p>
